...
/* package translate-app-0.1.0.0 */
#ifndef VERSION_translate_app
#define VERSION_translate_app "0.1.0.0"
#endif /* VERSION_translate_app */
#ifndef MIN_VERSION_translate_app
#define MIN_VERSION_translate_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_translate_app */
...
#define CURRENT_COMPONENT_ID "translate-app-0.1.0.0-inplace-translate-app"
